<template lang="">
  <section>
    ...
    <div class="container-xxl px-16px">
      <div class="row align-items-end justify-content-between g-32px">
        <div class="col-12 col-lg-6 row g-32px">
...
import FeaturedIconTopLeft from "@/components/elements/feature-text/_FeaturedIconTopLeft.vue";
export default {
  components: {
    FeaturedIconTopLeft,
  },
